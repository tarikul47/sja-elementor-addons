...
class SJA_Course_Categories_Widget extends \Elementor\Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'category_icon',
			[
				'label' => __('Card Icon Character', 'sja-elementor-addons'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => '🎓',
				'description' => __('Emoji/character shown inside the icon badge on every card.', 'sja-elementor-addons'),
			]
		);
					...
					<div class="divider-cta">
						...
						<div class="ctas">
							<?php if (!empty($settings['divider_primary_btn_label'])): ?>
								<a href="<?php echo esc_url(is_array($settings['divider_primary_btn_url']) ? ($settings['divider_primary_btn_url']['url'] ?? '') : $settings['divider_primary_btn_url']); ?>"
									class="btn btn-green">
									<?php echo esc_html($settings['divider_primary_btn_label']); ?>
								</a>
							<?php endif; ?>
							<?php if (!empty($settings['divider_secondary_btn_label'])): ?>
								<a href="<?php echo esc_url(is_array($settings['divider_secondary_btn_url']) ? ($settings['divider_secondary_btn_url']['url'] ?? '') : $settings['divider_secondary_btn_url']); ?>"
