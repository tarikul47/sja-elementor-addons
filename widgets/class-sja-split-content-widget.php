				...
				<div class="split <?php echo esc_attr( $layout_class ); ?>">
					<div>
						<?php if ( ! empty( $settings['eyebrow'] ) ) : ?>
							<span class="eyebrow <?php echo esc_attr( $eyebrow_class ); ?>"><?php echo esc_html( $settings['eyebrow'] ); ?></span>
						<?php endif; ?>
					...
					<div class="premium-img-wrap">
						...
						<div class="browser-mockup">
							...
							<?php if ( ! empty( $settings['browser_image']['url'] ) ) : ?>
								<img src="<?php echo esc_url( $settings['browser_image']['url'] ); ?>" alt="<?php echo esc_attr( $settings['section_title'] ); ?>" />
							<?php else : ?>
