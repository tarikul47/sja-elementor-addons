...
class SJA_Payment_Plan_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		?>
		<section id="<?php echo $mode === 'payment' ? 'plan' : 'journey'; ?>" class="<?php echo $mode === 'payment' ? 'alt' : ''; ?>">
			<div class="container">
				<?php if ( ! empty( $settings['eyebrow'] ) ) : ?>
					<span class="eyebrow <?php echo $mode === 'payment' ? 'green' : ''; ?>"><?php echo esc_html( $settings['eyebrow'] ); ?></span>
				<?php endif; ?>
				...
				<?php if ( ! empty( $settings['body_text'] ) ) : ?>
					<p class="lead" style="<?php echo $mode === 'payment' ? 'color:#3a4570;font-size:16px;margin-bottom:18px' : 'color:#475275;font-size:16px;margin-bottom:24px'; ?>"><?php echo wp_kses_post( $settings['body_text'] ); ?></p>
				<?php endif; ?>
					...
					<div class="plan">
						...
						<div style="margin-top: 20px;">
							...
							<?php if ( ! empty( $settings['highlight_text'] ) ) : ?>
								<p style="color:var(--green-dark);font-weight:800;font-size:18px"><?php echo esc_html( $settings['highlight_text'] ); ?></p>
							<?php endif; ?>
						</div>
					</div>
				<?php endif; ?>
				...
				<?php if ( ! empty( $settings['cta_label'] ) ) : ?>
					<div style="text-align:center;margin-top:40px">
						<a href="<?php echo esc_url( is_array( $settings['cta_url'] ) ? ( $settings['cta_url']['url'] ?? '' ) : $settings['cta_url'] ); ?>" class="btn btn-<?php echo esc_attr( $settings['cta_style'] ); ?>">
